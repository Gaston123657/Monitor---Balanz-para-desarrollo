...
_INSTRUMENT_SHEETS = ("Soberanos", "Tasa_Fija", "CER", "Dolar_Linked", "TAMAR", "ONs")
...
SHEET_SCHEMAS: Dict[str, Dict[str, Any]] = {
    ...
    "ONs": {
        "label": "Obligaciones Negociables (corporativos AR)",
        "fields": [
            {"key": "ticker",          "label": "Ticker",               "type": "text",   "required": True,
             "help": "Sufijo D = MEP (USD). Pesos (O) y Cable (C) no se muestran en panel."},
            {"key": "short_name",      "label": "Nombre emisor",        "type": "text",   "required": True},
            {"key": "tipo",            "label": "Tipo",                 "type": "select", "required": True,
             "options": ["ON"]},
            {"key": "sector",          "label": "Sector",               "type": "text",
             "help": "Ej. 'Petróleo y Gas', 'Servicios Públicos y Generación'"},
            {"key": "legislacion",     "label": "Legislación",          "type": "select", "required": True,
             "options": ["", "NY", "AR"],
             "help": "Filtra paneles ons_ny / ons_ar"},
            {"key": "isin",            "label": "ISIN",                 "type": "text",
             "help": "Identificador internacional"},
            {"key": "fecha_emision",   "label": "Fecha emisión",        "type": "date",   "required": True},
            {"key": "fecha_vencimiento","label": "Vencimiento",         "type": "date",   "required": True},
            {"key": "cupon anual %",   "label": "Cupón anual %",        "type": "text",   "required": True,
             "help": "Ej. 8.5 (porcentual anual)"},
            {"key": "frecuencia pagos","label": "Frecuencia pagos /año","type": "number", "step": "1",
             "help": "4 = trimestral (default ONs USD), 2 = semestral"},
            {"key": "base calculo",    "label": "Base cálculo",         "type": "select",
             "options": _BASE_CALCULO_OPTIONS,
             "help": "30/360 (NY) o ACT/365 (AR) según prospecto"},
            {"key": "tipo amortizacion","label": "Tipo amortización",   "type": "select",
             "options": _TIPO_AMORT_OPTIONS},
            {"key": "amort inicio",    "label": "Amort inicio",         "type": "date",
             "help": "Primera fecha de amortización (solo amortizing)"},
            {"key": "amort cantidad",  "label": "Cant. cuotas amort.",  "type": "number", "step": "1"},
            {"key": "amort frec",      "label": "Amort frec /año",      "type": "number", "step": "1",
             "help": "Si difiere de frecuencia de cupón (ej. cupón Q + amort S)"},
            {"key": "amort %",         "label": "Amort % por cuota",    "type": "number", "step": "0.01",
             "help": "Override del default 100/cantidad. Ej. 5 si cada cuota paga 5%"},
            {"key": "amort cant1",     "label": "Amort cant 1er tramo", "type": "number", "step": "1",
             "help": "Schedule de 2 tramos: N cuotas a 'amort %', luego resto a 'amort %2'"},
            {"key": "amort %2",        "label": "Amort % 2do tramo",    "type": "number", "step": "0.01"},
        ],
    },
}
